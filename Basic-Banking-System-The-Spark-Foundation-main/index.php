  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="intro py-1">
            <div >
                <div >
                   <center> <h1>BANKING MANAGEMENT</h1></center>
                </div>
            </div>
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                <br><br>
                <img src="img/uss.jpg" class="img-fluid">
                <br><br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>Made by <b>SHRIRAAM MANIKANDARAJ</b> <br> For the Project of  <b>The Sparks Foundation</b></p>
    </footer>
